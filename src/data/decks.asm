DeckPointers::
	...
	dw ReshuffleDeck
	dw ImakuniDeck
	dw AllFightingPokemonDeck
	dw BenchAttackDeck
	dw BattleContestDeck
	dw SqueakingMouseDeck
	dw GreatQuakeDeck
	dw BoneAttackDeck
	dw BlueWaterDeck
	dw OnTheBeachDeck
	...
	dw PokemonFluteDeck
	dw YellowFlashDeck
	dw ElectricShockDeck
	dw InsectCollectionDeck
	dw JungleDeck
	dw PsychicPowerDeck
	dw DreamEaterHaunterDeck
	dw ScavengingSlowbroDeck
	dw ScienceCorpsDeck
	dw ReplaceEmAllDeck
	dw ChariSaurDeck
	dw TrafficLightDeck
